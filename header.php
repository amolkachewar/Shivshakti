    ...
    <h1 class="logo mr-auto"><a href="index.php"><img src="images/abcd.png" alt="Logo" width="100" height="100" img-right; ></a></h1><br>
      ...
      <!--  <li class="active"><a href="place.php">placement</a></li>-->
       ...
       <!--   <li><a href="#placement">Placement</a></li>-->
          <li class="drop-down"><b><a href="index.php"><strong>Resource</strong></a></b>
          <ul>
               <li><a href="gallery.php">Gallery</a></li>
              <li><a href="news_artical.php">News articles</a></li>
              <li><a href="index.php">FCRA updates</a></li>
              <li><a href="media.php">Newsletter</a></li>
           </ul></li>
         ...
         <!-- <li><a href="Contact">Contact</a></li>-->
          ...
          <li class="drop-down"><b><a href="CSR Partnership"><strong>CSR Partnership</strong></a></b>
            <ul>
               <li><a href="index.php">Our Partner</a></li>
              <li><a href="index.php">Our Program</a></li>
              <li><a href="index.php">Cause related marketing</a></li>
              <li><a href="index.php">Payroll giving</a></li>
               <li><a href="index.php">Employee Volunteering</a></li>
           </ul></li>
