  ...
  <main id="main">
    ...
    <section id="about" class="about">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6">
            <div class="skill.jpg" data-aos="fade-right" data-aos-delay="100">
    ...
    <section id=" Our Projects" class="projects section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <img src="pmmmm.jpg" width="250" height="200">
        <img src="ele.png" width="250" height="200">
        <img src="csr.jpg" width="250"  height="200">
        <img src="Trasforming_Rural_logo.png" width="250" height="200">
        
          </div>
          <!--
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
              <div class="sub-heading" style="background: #fff0da;"><i class="sub-heading" style="color: #e98e06;"></i></div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row feature-item">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <img src="sses.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 wow fadeInUp pt-5 pt-lg-0" data-aos="fade-left" data-aos-delay="150">
            <h4><b>Shree Shivshakti Education Society (SSES):</b></h4>
            <p>
        ...
        <div class="row feature-item mt-5 pt-5">
          <div class="col-lg-6 wow fadeInUp order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="food.jpg" class="img-fluid" alt="">
          </div>

          <div class="col-lg-6 wow fadeInUp pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-right" data-aos-delay="150">
            <h4><b>Neque saepe temporibus repellat ea ipsum et. Id vel et quia tempora facere reprehenderit.</b></h4>
            <p>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
            <div class="portfolio-wrap">
              <img src="ssespic.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
    ...
    <section id="faq" class="faq">
      <div class="container" data-aos="fade-up">
        <header class="section-header">
          ...
          <p>If you have any query solve here regarding our educational society.</p>
        </header>

        <ul id="faq-list" data-aos="fade-up" data-aos-delay="100">
          <li>
            <a data-toggle="collapse" class="collapsed" href="#faq1">How do I submit an application? <i class="ion-android-remove"></i></a>
            <div id="faq1" class="collapse" data-parent="#faq-list">
              <p>
               for an application process you must have to contact for more details regarding the application form.
              </p>
            </div>
          </li>

          <li>
            <a data-toggle="collapse" href="#faq2" class="collapsed">The courses which provide by Shree Shivshakti Education Society is free? <i class="ion-android-remove"></i></a>
            <div id="faq2" class="collapse" data-parent="#faq-list">
              <p>
                Yes, we are working as training partner of pmkvy(Pradhan Mantri Kaushalya Vikas Yojana) so we provide free training .
              </p>
            </div>
          </li>

          <li>
            <a data-toggle="collapse" href="#faq3" class="collapsed">How do I decide which course to take? <i class="ion-android-remove"></i></a>
            <div id="faq3" class="collapse" data-parent="#faq-list">
              <p>
                According to your interest ,education and as per eligibility criteria you have to choose.
              </p>
            </div>
          </li>

          <li>
            <a data-toggle="collapse" href="#faq4" class="collapsed">Are you provide any certification after completion of course? <i class="ion-android-remove"></i></a>
            <div id="faq4" class="collapse" data-parent="#faq-list">
              <p>
                yes,we provide an certicfication of course.
              </p>
            </div>
          </li>
<!--
