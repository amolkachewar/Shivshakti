...
<html>
  ...
  <body>
    ...
    <img src="https://i.pinimg.com/originals/63/7a/4b/637a4be189b5b5db494e66940df579e7.gif" alt="Donate to shivshakti" height="630" srcset="">
    <section>
        <div class="donationtype">
            ...
            <div>
                <h1 class="display-4">Donation through wire tranfer/check/DD.</h1>
                    <p>If you are in Bangalore, Chennai, Mumbai, Kolkata or Hyderabad, we will come to your residence to pick up your donation cheque as and when required..</p>
